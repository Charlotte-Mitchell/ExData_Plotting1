## plot2.R <- load and create plot1 for the assignment
...
plot(time_period$DateandTime, time_period$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
